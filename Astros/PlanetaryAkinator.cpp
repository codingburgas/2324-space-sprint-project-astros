...
void playPlanetaryAkinator()
{
		clear();
		PrintLogo();
		string starterQuestions[2] = { "Are you thinking of an inner planet?", "Does your planet have a significant atmosphere that can sustain a weather system?" }, planets[8] = { "Mercury", "Venus","Earth","Mars","Jupiter","Saturn","Uranus","Neptune" },answer; //Neptune */  }
