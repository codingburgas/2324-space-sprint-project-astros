...
using namespace std;
void PrintLogo() {
    centerText("      __        ________  ___________  _______     ______    ________  \n");
    centerText("     /\"\"\\      /\"       )(\"     _   \")/\"      \\   /    \" \\  /\"       ) \n");
    centerText("    /    \\    (:   \\___/  )__/  \\\\__/|:        | // ____  \\(:   \\___/  \n");
    centerText("   /' /\\  \\    \\___  \\       \\\\_ /   |_____/   )/  /    ) :)\\___  \\    \n");
    centerText("  //  __'  \\    __/  \\\\      |.  |    //      /(: (____/ //  __/  \\\\   \n");
    centerText(" /   /  \\\\  \\  /\" \\   :)     \\:  |   |:  __   \\ \\        /  /\" \\   :)  \n");
    centerText("(___/    \\___)(_______/       \\__|   |__|  \\___) \\\"_____/  (_______/   \n");
    cout << endl;
}
